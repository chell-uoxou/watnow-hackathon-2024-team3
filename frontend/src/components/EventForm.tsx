    ...
    <form>
      <div className="max-w-{size} py-5">
        ...
        <div className="pb-20">
          ...
          <div>
            <Input name="name" id="name" className="max-w-{size} mb-12" />
          </div>
          <div className="text-sm max-w-{size} text-left">説明</div>
          <div>
            <Input name="description" id="description" className="max-w-{size} mb-12" />
          </div>
          <div className="text-sm max-w-{size} text-left">場所</div>
          <div>
            <Input name="location" id="location" className="max-w-{size} mb-12" />
          </div>
          <div className="flex">
          ...
          <div>
            <Input name="time" id="time" className="max-w-{size} mb-12" />
          </div>
          <div className="flex">
          ...
          <div className="flex">
            ...
            <div className="flex-1 pl-2 w-full lg:w-1/2">
              <div>
                <Input name="value" id="value" className="max-w-{size}" />
              </div>
            </div>
          </div>
          ...
          <div>
            <Input name="participants" id="participants" className="max-w-{size} mb-12" />
          </div>
          ...
          <div className="flex flex-wrap">
            ...
            <Textarea name="memo" id="memo" className="max-w-{size} mb-12 h-24" />
          </div>
